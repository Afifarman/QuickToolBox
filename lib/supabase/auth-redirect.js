 ...
 * The browser origin is used so OAuth also works on the production custom domain
 * and Vercel preview deployments, provided those URLs are allowlisted in Supabase.
 */
...
export const PRODUCTION_SITE_HOSTS = [
  ...
  'quick-tool-box-gfr1.vercel.app',
  'quick-tool-box-gfr1-armanarif852-2879s-projects.vercel.app',
];

export const SUPABASE_REDIRECT_ALLOWLIST = [
  'http://localhost:3000/**',
  'https://www.quick-tool-box-vercel.app/auth/callback',
  'https://www.quick-tool-box-vercel.app/reset-password',
  'https://quick-tool-box-vercel.app/auth/callback',
  'https://quick-tool-box-vercel.app/reset-password',
